...
namespace FileGlitcherTest.ProcessorTests
{
  ...
  class MathProcessorTest
  {
    ...
    public void AddNoWrapAroundTest()
    {
      ...
      MathProcessor proc = new MathProcessor(new FixedByteProvider(10), Operation.Add, false);
    ...
    public void AddWrapAroundTest()
    {
      // given: MathProcessor
      byte[] bytes = new byte[] { 250, 1, 2, 3, 4, 5, 6, 7, 8, 9 };
      MathProcessor proc = new MathProcessor(new FixedByteProvider(10), Operation.Add, true);
    ...
    public void SubtractNoWrapAroundTest()
    {
      ...
      MathProcessor proc = new MathProcessor(new FixedByteProvider(10), Operation.Subtract, false);
    ...
    public void SubtractWrapAroundTest()
    {
      // given MathProcessor
      byte[] bytes = new byte[] { 5, 11, 12, 13, 14, 15, 16, 17, 18, 19 };
      MathProcessor proc = new MathProcessor(new FixedByteProvider(10), Operation.Subtract, true);
